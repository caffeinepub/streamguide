  ...
  const helpItems = [
    {
      ...
      description:
        "Learn more about our services, pricing, and how we can help your family.",
    },
    {
      title: "Stream Selection Guidance",
      description:
        "Get initial advice on choosing between Science, Commerce, and Arts streams.",
    },
    {
      title: "Test Information",
      description:
        "Understand our psychometric testing process and what to expect.",
    },
    {
      title: "Counseling Details",
      description:
        "Learn about our one-on-one counseling sessions and how they work.",
    },
    {
      title: "Parent Consultations",
      description:
        "Discuss your concerns as a parent and how we can support your child.",
    },
    {
      title: "Follow-up Support",
      description:
        "Get additional guidance after your initial consultation or test.",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              ...
              can help you choose the right educational path? We're here to
              help!
            </p>
            <button
              type="button"
