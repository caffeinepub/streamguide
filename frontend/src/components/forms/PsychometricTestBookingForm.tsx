    ...
    <form onSubmit={handleSubmit} className="space-y-6 bg-card border border-border rounded-xl p-6 md:p-8">
      ...
      <div className="flex items-center justify-between bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border border-amber-600/30 rounded-lg p-4 mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-foreground uppercase tracking-wide">Intro Offer</span>
        </div>
        <div className="flex items-baseline gap-2">
          <span className="text-xl md:text-2xl font-bold text-amber-600">Rs. 749</span>
          <span className="text-sm text-muted-foreground line-through">Rs. 1249</span>
        </div>
      </div>
